 ...
 */
static int startn3ds_input(gamespec *gs)
{
 ...
 * level.
 */
static int endn3ds_input(gamespec *gs)
{
    char	yn[2];
 ...
 * series.
 */
static int finaln3ds_input(gamespec *gs)
{
    int	cmd;
