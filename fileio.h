 ...
 */
extern int filereadint8_t(fileinfo *file, unsigned char *val8,
			char const *msg);
extern int filewriteint8_t(fileinfo *file, unsigned char val8,
			 char const *msg);
extern int filereadint16_t(fileinfo *file, unsigned short *val16,
			 char const *msg);
extern int filewriteint16_t(fileinfo *file, unsigned short val16,
			  char const *msg);
extern int filereadint32_t(fileinfo *file, unsigned long *val32,
			 char const *msg);
extern int filewriteint32_t(fileinfo *file, unsigned long val32,
			  char const *msg);
